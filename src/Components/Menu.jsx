...
export function Menu(){
    ...
    <>
        ...
        <MenuItem exact to="/home" className = "menu-bars">
                <div className="menuIcon"><AiFillPieChart size={40}/></div>
                <div className="menuText">Home</div>
        </MenuItem>
        <MenuItem to="/trends" className = "menu-bars">
                <div className="menuIcon"><RiLineChartFill size={40}/></div>
                <div className="menuText">Trends</div>
        </MenuItem>
        <MenuItem to="/account" className = "menu-bars">
                <div className="menuIcon"><BsFillPersonFill size={40}/></div>
                <div className="menuText">Account</div>    
        </MenuItem>
        <MenuItem to="/settings" className = "menu-bars">
                <div className="menuIcon"><AiFillSetting size={40}/></div>
                <div className="menuText">Setings</div>   
        </MenuItem>
        <LogOut to="/login" className = "menu-bars">
                <div className="menuIcon"><IoLogOut size={40}/></div>
